(function () {
  ...
  function UpdateMatrices() {
      ...
      const at = fromValues(0.0, 0.0, 0.0);
      const up = fromValues(0.0, 1.0, 0.0);

      lookAt(viewMatrix, fromValues(x, y, z), at, up);
      ...
      perspective(projMatrix, fovy, aspect, near, far);

      // Inverse VP matrix
      invert(invVP, multiply(invVP, viewMatrix, projMatrix));
  }
